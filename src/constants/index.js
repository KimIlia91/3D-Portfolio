...
const projects = [
    ...
    },
    {
      name: "Irsen Media",
      description:
        "Landing page компании предоставляющей услуги наружной рекламы на Медиабордах. На сайте доступна интерактивная карта с размещением медиабордов, чтобы клиенты могли выбрать оптимальные локации для своих рекламных кампаний, также на сайте есть интерактивный Медиаборд чтобы клиент мог загрузить свой рекламный ролик и прмерно посмотреть как его реклама будет выглядеть на Медиаборде, присуствует форма для отправки контактной информации.",
      tags: [
        {
          name: "next.js",
          color: "blue-text-gradient",
